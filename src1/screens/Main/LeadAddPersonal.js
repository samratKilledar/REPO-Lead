...
// import NavigationHeaderBack from '../../components/NavigationHeaderBack';
// import Stepper from '../../components/StepperComp';
// import { updatePersonalField, submitPersonalDetails } from '../../redux/actions/personalAction';

// const LeadAddPersonal = (props) => {
//   const dispatch = useDispatch();
//   const { personalValue } = useSelector((state) => state.LeadAddPersonalReducer);

//   const handleInputChange = (field, value) => {
//     dispatch(updatePersonalField({ [field]: value }));
//   };
...
//           <Dropdown
//             label="Lead Service"
//             selectedValue={personalValue.leadService}
//             onValueChange={(value) => handleInputChange('leadService', value)}
//             options={[{ label: 'Online', value: 'Online' }, { label: 'Offline', value: 'Offline' }]}
//             zIndex={3000}
//           />
...
//           />
//           <CustomTextInput
//             value={personalValue.emailId}
//             placeholder="Email Id"
//             onChangeText={(value) => handleInputChange('emailId', value)}
//           />
//           <CustomTextInput
//             value={personalValue.whatsappNo}
//             placeholder="Whatsapp No"
//             onChangeText={(value) => handleInputChange('whatsappNo', value)}
//           />
//           <CustomTextInput
//             value={personalValue.addressLine1}
//             placeholder="Address Line 1"
//             onChangeText={(value) => handleInputChange('addressLine1', value)}
//           />
//           <CustomTextInput
//             value={personalValue.addressLine2}
//             placeholder="Address Line 2"
//             onChangeText={(value) => handleInputChange('addressLine2', value)}
//           />
//           <Dropdown
//             label="City"
//             selectedValue={personalValue.city}
//             onValueChange={(value) => handleInputChange('city', value)}
//             options={[{ label: 'Mumbai', value: 'Mumbai' }, { label: 'Thane', value: 'Thane' }, { label: 'Navi Mumbai', value: 'Navi Mumbai' }, { label: 'Panvel', value: 'Panvel' }]}
//             zIndex={5000}
//           />
//           <Dropdown
//             label="State"
//             selectedValue={personalValue.state}
//             onValueChange={(value) => handleInputChange('state', value)}
//             options={[{ label: 'Maharashtra', value: 'Maharashtra' }, { label: 'Gujrat', value: 'Gujarat' }, { label: 'Goa', value: 'Goa' }, { label: 'Karnataka', value: 'Karnataka' }]}
//             zIndex={4000}
//           />
//           <Dropdown
//             label="Country"
//             selectedValue={personalValue.country}
//             onValueChange={(value) => handleInputChange('country', value)}
//             options={[{ label: 'India', value: 'India' }, { label: 'USA', value: 'USA' }, { label: 'Australia', value: 'Australia' }]}
//             zIndex={3000}
//           />
//           <CustomTextInput
