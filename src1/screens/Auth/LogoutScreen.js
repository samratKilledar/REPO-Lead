...
//           <TouchableOpacity style={styles.profilepicContainer} onPress={() => navigation.navigate('EditProfileScreen')}>
...
//               <CustomButton title={"Yes, logout"} customStyle={{ width: width - 30 }} onPress={() => navigation.navigate('LoginScreen')} />
