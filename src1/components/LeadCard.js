...
const LeadCard = props => {
  ...
  const [menuVisible, setMenuVisible] = useState(false);
  const [modalVisible, setModalVisible] = useState(false);
  const [confirmationModalVisible, setConfirmationModalVisible] = useState(false); // New state for confirmation modal
  ...
  const handleDeleteClick = () => {
    setConfirmationModalVisible(true); // Show confirmation modal on delete click
  };
...
<Modal
  ...
  <View style={styles.deletemodalContainer}>
    <View style={styles.deletemodalContent}>
      <Text style={styles.deletemodalTitle}>Are you sure want to delete?</Text>
      <View style={styles.deletemodalActions}>
      <TouchableOpacity
          style={styles.deleteBlueButton}
          onPress={handledelete}>
          <Text style={styles.deleteBlueButtonText}>Yes</Text>
        </TouchableOpacity>
        <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  deleteBlueButton: {
    backgroundColor: '#007bff', // Blue background for "Yes"
    paddingVertical: 10,
  ...
  deleteBlueButtonText: {
    color: 'white',
    fontSize: 16,
    fontWeight: '500',
  },
  deleteCancelButton: {
    backgroundColor: '#dc3545', // Red background for "No"
    paddingVertical: 10,
    paddingHorizontal: 20,
    borderRadius: 5,
    marginTop: 10,
